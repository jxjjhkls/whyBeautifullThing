// ======================================================================
// IRCode.v generated from TopDesign.cysch
// 09/01/2016 at 23:25
...
`ifdef WARP
`define CY_BLK_DIR "C:\Program Files\Cypress\PSoC Creator\3.3\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\Bus_Connect_v2_40"
`include "C:\Program Files\Cypress\PSoC Creator\3.3\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\Bus_Connect_v2_40\Bus_Connect_v2_40.v"
`else
`define CY_BLK_DIR "C:\Program Files\Cypress\PSoC Creator\3.3\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\Bus_Connect_v2_40"
`include "C:\Program Files\Cypress\PSoC Creator\3.3\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\Bus_Connect_v2_40\Bus_Connect_v2_40.v"
`endif
...
module ADC_SAR_SEQ_P4_v2_40_1 (
	...
	cy_clock_v1_0
		#(.id("8915c2f2-2815-4137-9ab8-52dbbd62670e/5c71752a-e182-47ca-942c-9cb20adbdf2f"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("125000000"),
		  .is_direct(0),
...
module top ;
    ...
    ADC_SAR_SEQ_P4_v2_40_1 ADC_SAP (
        .Vref(Net_679),
        .sdone(Net_680),
        .eoc(Net_681),
        .aclk(1'b0),
	...
	wire [0:0] tmpOE__Samp_DIN_net;
	wire [0:0] tmpFB_0__Samp_DIN_net;
	wire [0:0] tmpIO_0__Samp_DIN_net;
	wire [0:0] tmpINTERRUPT_0__Samp_DIN_net;
	electrical [0:0] tmpSIOVREF__Samp_DIN_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		Samp_DIN
		 (.oe(tmpOE__Samp_DIN_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Samp_DIN_net[0:0]}),
		  .analog({Net_668}),
		  .io({tmpIO_0__Samp_DIN_net[0:0]}),
		  .siovref(tmpSIOVREF__Samp_DIN_net),
		  .interrupt({tmpINTERRUPT_0__Samp_DIN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Samp_DIN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__CTL_DOut_net;
	wire [0:0] tmpFB_0__CTL_DOut_net;
	wire [0:0] tmpIO_0__CTL_DOut_net;
	wire [0:0] tmpINTERRUPT_0__CTL_DOut_net;
	electrical [0:0] tmpSIOVREF__CTL_DOut_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("52f31aa9-2f0a-497d-9a1f-1424095e13e6"),
		  ...
		  .input_buffer_sel(2'b00))
		CTL_DOut
		 (.oe(tmpOE__CTL_DOut_net),
		  .y({Net_826}),
		  .fb({tmpFB_0__CTL_DOut_net[0:0]}),
		  .io({tmpIO_0__CTL_DOut_net[0:0]}),
		  .siovref(tmpSIOVREF__CTL_DOut_net),
		  .interrupt({tmpINTERRUPT_0__CTL_DOut_net[0:0]}),
		  .annotation({Net_667}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__CTL_DOut_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_clock_v1_0
		#(.id("a5d7e752-9a70-4256-8913-d42709ff9b7c"),
		  .source_clock_id(""),
		  .divisor(0),
